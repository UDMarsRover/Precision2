...
UDMRT_Ultrasonic::UDMRT_Ultrasonic(char* name, 
                         ...
                         int min_distance,
                         double alpha_value):
    UDMRT_Sensor<sensor_msgs::msg::Range>(name, node) {

    alphaValue = alpha_value;
    data_msg.radiation_type = sensor_msgs::msg::Range::ULTRASOUND;
...
void UDMRT_Ultrasonic::init(NewPing* sensor, Publisher* dataPublisher, Publisher* diagnosticPublisher) {
